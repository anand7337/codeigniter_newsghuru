 ...
 <section class="description_section">
    <div class="container">
        <div class="row row_wrapper">
            ...
            if(isset($data1)){
            ?>
            <div class=""><a href="<?=base_url('admin/edit_kollywood/').$data1[0]->id ?>">Edit</a></div>
            <div class=""><a href="<?=base_url('admin/delete_kollywood/').$data1[0]->id ?>">Delete</a></div>
                ...
                <div class="left_card">
                    ...
                    <div class="desc_main">
                        ...
                        <div class="desc_img mb-3 mt-3">
                            <img src="<?=base_url('./upload/kollywood/').$data1[0]->image1?>"
                                alt="">
                        </div>
                        <p></p>
                    </div>
                    <div class="desc_main1">
                        ...
                        <div class="desc_img1 mb-3 mt-3">
                            <img src="<?=base_url('./upload/kollywood/').$data1[0]->image2?>"
                                alt="">
                        </div>
                        <p></p>
                    </div>
