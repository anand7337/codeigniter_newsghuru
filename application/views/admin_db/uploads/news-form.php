<main class="app-content">
    <div class="app-title">
        <div>
            <h1><i class="bi bi-cricket"></i>News</h1>
        </div>
    </div>
    <div class="row form_upload_main">
        <div class="col-md-12 col-lg-8">
            <div class="tile">
                ...
                <div class="tile-body">
                    <form action="<?= base_url('admin/news_form_upload') ?>" method="post" enctype="multipart/form-data">
                        <div class="mb-3">
                            <label class="form-label">Select Category</label>
                            <select class="form-control" type="text" name="category" placeholder="Write Something....">
                                <option value="not-selected">--Not Selected--</option>
                                <option value="local-news">உள்ளூர் செய்திகள்</option>
                                <option value="weather-news">வானிலை செய்திகள்</option>
                                <option value="world-news">உலக செய்திகள்</option>
                            </select>
                        </div>
                        <div class="mb-3">
