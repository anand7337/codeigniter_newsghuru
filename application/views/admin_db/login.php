...
<html>
  ...
  <body>
    ...
    <section class="login-content">
      ...
      <div class="login-box">
        <form action="<?=base_url('admin/login_form/');?>" method="post" class="login-form">
          <h3 class="login-head"><i class="bi bi-person me-2"></i>Admin Login</h3>
          <div class="mb-3">
          ...
          <div class="mb-3 btn-container d-grid">
            <button type="submit" name="submit" class="btn btn-primary btn-block" value="signin"><i class="bi bi-box-arrow-in-right me-2 fs-5"></i>SIGN IN</button>
          </div>
        </form>
