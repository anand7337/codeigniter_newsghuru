                        ...
                        if (isset($data1)) {
                            foreach ($data1 as $row) {
                                ...
                                <div class="middle_article">
                                    <a href="<?= base_url('main/tvshows_click_review/') . $row->id . "/" . $row->title?>" class="article_title">
                                        <?= $row->title ?>
                                    </a>
                                    ...
                                    <div class="middle_art_main">
                                        ...
                                        <a href="<?= base_url('main/tvshows_click_review/') . $row->id . "/" . $row->title?>" class="article_a">
