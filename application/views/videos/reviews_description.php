                    ...
                    <div class="desc_main">
                        ...
                        <div class="desc_vd mb-3 mt-3">
                            <?php   
                              if($data2[0]->video1){
                            ?>
                               <video src="<?=base_url('./upload/videos/').$data2[0]->video1?>" controls alt=""></video>
                            <?php
                               }else{
                                 "style='display:none'";
                               }
                    ...
                    <div class="desc_main1">
                        <div class="desc_vd1 mb-3 mt-3">
                            <?php
                             if($data2[0]->video2){
                            ?>
                            <video src="<?=base_url('./upload/videos/').$data2[0]->video2?>" controls
                                alt=""></video>
                                <?php
                                     }else{
                                        "style='display:none'";
                    ...
                    <div class="desc_main1">
                        <div class="desc_vd1 mb-3 mt-3">
                            <?php
                              if($data2[0]->video3){
                            ?>
                            <video src="<?=base_url('./upload/videos/').$data2[0]->video3?>" controls
                                alt=""></video>
                                <?php
                                  }else{
                                    "style='display:none'";
                    ...
                    <div class="desc_main1">
                        <div class="desc_vd1 mb-3 mt-3">
                            <?php
                              if($data2[0]->video4){
                            ?>
                            <video src="<?=base_url('./upload/videos/').$data2[0]->video4?>" controls
                                alt=""></video>
                                <?php
                                      }else{
                                        "style='display:none'";
                    ...
                    <div class="desc_main1">
                        <div class="desc_vd1 mb-3 mt-3">
                            <?php
                              if($data2[0]->video5){
                            ?>
                            <video src="<?=base_url('./upload/videos/').$data2[0]->video5?>" controls
                                alt=""></video>
                                <?php
                                   }else{
                                    "style='display:none'";
